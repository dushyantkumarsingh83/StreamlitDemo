...
if app_mode=='Home':
    ...
    data1={'Gender':Gender, 'Married':Married, 'Dependents':[class_0,class_1,class_2,class_3], 'Education':Education, 'ApplicantIncome':ApplicantIncome,
       'CoapplicantIncome':CoapplicantIncome, 'Self Employed':Self_Employed, 'LoanAmount':LoanAmount, 'Loan_Amount_Term':Loan_Amount_Term,
...
#STREAMED: https://github.com/dushyantkumarsingh83/streamlit_loadPrediction
